const scriptURL = 'https://script.google.com/macros/s/AKfycbws69TPxqPCQkGsZ0IYsUtpu0l2SH2bbj_8YPGDqdZL7yN0dnqJekHmWmJaaDEgencr/exec'

const form = document.forms['contact-formMK']
...
form.addEventListener('submit', e => {
  ...
  .catch(error => console.error('Error, no se pudo registrar', error.message))
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.getElementById('registroFormMK').addEventListener('submit', function() {
